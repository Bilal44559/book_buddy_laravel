            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-12">
                            <form action="{{ route('user.groups.update', $group->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="text" id="name"
                                                ...
                                                placeholder="Enter Group Name" name="name" value="{{ old('name', $group->name) }}" required />
                                            @error('name')
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-1">
                                            ...
                                            <textarea class="form-control @error('description') is-invalid @enderror" name="description" id="description" 
                                                cols="30" rows="3" placeholder="Enter Group Description">{{ old('description', $group->description) }}</textarea>
                                            @error('description')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
