                ...
                <div class="card">
                    <div class="card-body">
                        <div class="mt-2">
                            ...
                            <p class="card-text">{{date("M d,Y",strtotime($user->created_at))}}</p>
                        </div>
                        <div class="mt-2">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-start align-items-center mt-2">
                            ...
                            <div class="profile-user-info">
                                <a href="{{ route('user.social_feed.author_profile', $other_user->id) }}">
                                <h6 class="mb-0">{{ $other_user->name }}</h6>
                                </a>
                            </div>
                            @if(!checkUserFollowing($other_user->id))
                            <a href="{{ route('user.social_feed.store_following_user', $other_user->id) }}" class="btn btn-primary btn-icon btn-sm ms-auto">
