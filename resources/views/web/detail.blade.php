...
<h1>{{$book->title}} <span>(by {{$book->author->name}})</span></h1>
            <div class="image_panel">
                @if(!empty($book->image))
                <img src="{{ asset('storage/'.$book->image)}}" alt="CSS Template" width="100" height="150" />
                @else
                <img src="{{asset('/')}}images/templatemo_image_02.jpg" alt="CSS Template" width="100" height="150" />
                @endif
            </div>
