<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item {{ Request::is('books') ? 'active' : '' }}"><a class="d-flex align-items-center"
                    href="{{ route('books.index') }}"><i data-feather='book-open'></i><span
                        class="menu-title text-truncate" data-i18n="Dashboards">Books</span></a>
            </li>
            <li class=" nav-item {{ Request::segment(2) == "user-creation" ? 'active' : '' }}"><a class="d-flex align-items-center"
                    href="{{ route('user.user-creation.index') }}"><i data-feather="user"></i><span class="menu-title text-truncate"
                        data-i18n="Dashboards">Users</span></a>
            </li>
            <li class=" nav-item {{ Request::segment(2) == "reviews" ? 'active' : '' }}"><a class="d-flex align-items-center"
                href="{{ route('user.reviews.index') }}"><i data-feather="user"></i><span class="menu-title text-truncate"
