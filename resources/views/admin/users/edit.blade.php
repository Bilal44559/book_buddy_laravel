            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-12">
                            <form action="{{ route('user.user-creation.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="text" id="name"
                                                ...
                                                placeholder="Enter Name here" name="name" value="{{ old('name', $user->name) }}" />
                                            @error('name')
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="text" id="email"
                                                ...
                                                placeholder="Enter Email here" name="email" value="{{ old('email', $user->email) }}" />
                                            @error('email')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="mb-1">
                                            ...
                                            <select class="form-select @error('is_author') is-invalid @enderror" id="is_author" name="is_author">
                                                <option value="1" {{ old('is_author', $user->is_author) == 1 ? 'selected' : '' }}>Yes</option>
                                                <option value="0" {{ old('is_author', $user->is_author) == 0 ? 'selected' : '' }}>No</option>
                                            </select>
                                            @error('is_author')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
